...
public class GameConstants {
    ...
    public static final int DEFAULT_NPC = 9000500;
    public static final int TOWN_MAP = 910000000;
    public static final SavedLocationType TOWN_TYPE = SavedLocationType.FREE_MARKET;
    ...
    public static int getIntForCloseness(int exp) {
    ...
    public static boolean isThrowSkill(final int id) {
        switch (id) {
            case 5201002: // 스로잉 봄
            case 14111006: // 포이즌 봄
            case 4341003: // 몬스터 봄
    ...
    public static int getTaxAmount(final int meso) {
        if (meso >= 10000000) {
            ...
            return (int) Math.round(0.01 * meso);
        } else if (meso >= 50000) {
            return (int) Math.round(0.005 * meso);
        }
        return 0;
    }
    ...
    public static int EntrustedStoreTax(final int meso) {
        if (meso >= 10000000) {
            ...
            return (int) Math.round(0.0025 * meso);
        }
        return 0;
    }
    ...
    public final static int[] peanutsRiding = {
        2430091, 200,
        2430092, 200,
        2430093, 200,
        2430101, 200,
    ...
    public static int[] blockedMaps = {180000001, 180000002, 109050000, 280030000, 240060200, 280090000, 280030001, 240060201, 950101100, 950101010, 240060300};
...
//        return 10;
    ...
    public static boolean isProblemMap(int mapid) {
        switch (mapid) {
            case 100000002: //kerning PQ crocs
                return true;
            default:
                return mapid / 100000 == 9800 && (mapid % 10 == 1 || mapid % 1000 == 100);
        }
    ...
    public static boolean isDecentSkill(int skillId) {
    ...
    public static boolean isAccountSharableOnce(int itemId) {
        switch (itemId) {
            case 1112427:
            case 1112428:
            case 1112429:
    ...
    public static boolean isPickupRestricted(int itemId) {
        // && itemId != 4001168 && itemId != 4031306 && itemId != 4031307
        return itemId == 4030003 || itemId == 4030004 || itemId == 5370000
                || itemId == 3010000
                || itemId == 3010007
                || itemId == 3010008
                || itemId == 3010009;
...
//        }
    ...
    public static int getExpModByLevel(int level) {
        if (level >= 1 && level <= 10) {
            return 10;
        } else if (level >= 11 && level <= 70) {
            return 50;
        } else if (level >= 71 && level <= 100) {
            return 40;
        } else if (level >= 101 && level <= 140) {
            return 30;
        } else if (level >= 141 && level <= 200) {
            return 20;
    ...
    public static final int PET_SKILL1 = 122224;
    public static final int PET_SKILL2 = 122225;
    public static final int PET_SKILL3 = 122226;
    ...
    public static final int DAILY_QUEST_BONUS = 1540000;
    ...
    public static int getEquipQuality(final Equip equip) {
        if (equip.getUniqueId() > 0 || equip.getItemId() / 100000 == 19) {
            return 0;
        }
        int myEquipAll = 0;
        myEquipAll += equip.getStr();
        myEquipAll += equip.getAcc();
        myEquipAll += equip.getAvoid();
        myEquipAll += equip.getDex();
        myEquipAll += equip.getHands();
        myEquipAll += equip.getInt();
        myEquipAll += equip.getJump();
        myEquipAll += equip.getLuk();
        myEquipAll += equip.getMatk();
        myEquipAll += equip.getMdef();
        myEquipAll += equip.getMp();
        myEquipAll += equip.getHp();
        myEquipAll += equip.getSpeed();
        myEquipAll += equip.getWatk();
        myEquipAll += equip.getWdef();

        int defaultEquipAll = 0;
        ItemInformation defi = MapleItemInformationProvider.getInstance().getItemInformation(equip.getItemId());
        final Equip def = defi.eq;
        defaultEquipAll += def.getStr();
        defaultEquipAll += def.getAcc();
        defaultEquipAll += def.getAvoid();
        defaultEquipAll += def.getDex();
        defaultEquipAll += def.getHands();
        defaultEquipAll += def.getInt();
        defaultEquipAll += def.getJump();
        defaultEquipAll += def.getLuk();
        defaultEquipAll += def.getMatk();
        defaultEquipAll += def.getMdef();
        defaultEquipAll += def.getMp();
        defaultEquipAll += def.getHp();
        defaultEquipAll += def.getSpeed();
        defaultEquipAll += def.getWatk();
        defaultEquipAll += def.getWdef();

        int statDiff = myEquipAll - defaultEquipAll;
        if (statDiff < 0) {
            return -1;
        } else {
            if (statDiff < 6) {
