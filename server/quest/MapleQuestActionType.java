...
public enum MapleQuestActionType {
    ...
    UNDEFINED(-1), exp(0), item(1), nextQuest(2), money(3), quest(4), skill(5), pop(6), buffItemID(7), infoNumber(8), sp(9), info(16),
    charismaEXP(10), charmEXP(11), willEXP(12), insightEXP(13), senseEXP(14), craftEXP(15), npcAct(16);
    final byte type;
