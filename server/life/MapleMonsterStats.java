...
public class MapleMonsterStats {
    ...
    public static final Map<Integer, String> MobNameMap = new HashMap<>();
    ...
    private long hp;
    private int pddamage, mddamage, link, id, exp, mp, removeAfter, buffToGive, fixedDamage, selfDestruction_hp, dropItemPeriod, point, eva, acc, PhysicalAttack, MagicAttack, speed, partyBonusR, pushed, banType;
    ...
    public void setLink(int linkcost) {
        this.link = linkcost;
    }
    ...
    public void setPDDamage(final int PhysicalAttack) {
        this.pddamage = PhysicalAttack;
    }
    ...
    public final void setMDDamage(final int MagicAttack) {
        this.mddamage = MagicAttack;
    }

    public final int getMDDamage() {
        return mddamage;
    }
