...
public class PlayerNPC extends MapleNPC {
    ...
    public PlayerNPC() {
        super(9901000, "타락파워전사");
        this.setCoords(-278, 189, 1, 2);
        this.charId = 29999;
        this.mapid = 102000003;
        this.hair = 30210;
        this.face = 20605;
        this.skin = 0;
        this.gender = 0;
        ...
        equips.put((byte) -114, 1802020);
        equips.put((byte) -21, 1142107);
        equips.put((byte) -101, 1002237);
        equips.put((byte) -7, 1072037);
        equips.put((byte) -105, 1042158);
        equips.put((byte) -106, 1062054);
        equips.put((byte) -107, 1072153);
        equips.put((byte) -11, 1402047);
        equips.put((byte) -109, 1102070);
    }
