...
public class AttackInfo {
    ...
    public int display, bigbang;
    public byte hits, targets, tbyte, speed, csstar, AOE, slot, unk, animation, donno1, donno2, donno3, skilllevel;
    ...
    public final MapleStatEffect getAttackEffect(final MapleCharacter chr, int skillLevel, final Skill skill_) {
        ...
        int dd = ((display & 0x8000) != 0 ? (display - 0x8000) : display);//display - 0x8000하면 크리티컬로만보임.
