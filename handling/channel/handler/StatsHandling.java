...
public class StatsHandling {
    ...
    public static final void AutoAssignAP(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        ...
        if (chr.getRemainingAp() == amount + amount2) {
            switch (PrimaryStat) {
                case 64: // Str
                    if (playerst.getStr() + amount > 9999) {
                        return;
                    }
                    ...
                    break;
                case 128: // Dex
                    if (playerst.getDex() + amount > 9999) {
                        return;
                    }
                    ...
                    break;
                case 256: // Int
                    if (playerst.getInt() + amount > 9999) {
                        return;
                    }
                    ...
                    break;
                case 512: // Luk
                    if (playerst.getLuk() + amount > 9999) {
                        return;
                    }
            ...
            switch (SecondaryStat) {
                case 64: // Str
                    if (playerst.getStr() + amount2 > 9999) {
                        return;
                    }
                    ...
                    break;
                case 128: // Dex
                    if (playerst.getDex() + amount2 > 9999) {
                        return;
                    }
                    ...
                    break;
                case 256: // Int
                    if (playerst.getInt() + amount2 > 9999) {
                        return;
                    }
                    ...
                    break;
                case 512: // Luk
                    if (playerst.getLuk() + amount2 > 9999) {
                        return;
                    }
        ...
        if (chr.getRemainingAp() > 0) {
            switch (slea.readInt()) {
                ...
                case 2048: // HP
                    ...
                    } else if ((job >= 300 && job <= 322) || (job >= 400 && job <= 422)) { // Bowman & Thief
    ...
    public static final void DistributeSP(final int skillid, final MapleClient c, final MapleCharacter chr) {
        ...
        for (int i : GameConstants.blockedSkills) {
            if (skill.getId() == i) {
                c.getSession().write(MaplePacketCreator.enableActions());
                chr.dropMessage(1, "사용할 수 없는 스킬입니다.");
                return;
            }
        }
