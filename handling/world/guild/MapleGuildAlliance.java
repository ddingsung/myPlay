...
public class MapleGuildAlliance implements java.io.Serializable {
    ...
    public static final int CHANGE_CAPACITY_COST = 5000000;
    ...
    public void setNotice(String newNotice) {
        ...
        broadcast(MaplePacketCreator.getAllianceUpdate(this));
        broadcast(MaplePacketCreator.serverNotice(5, "길드 연합 공지사항 : " + newNotice));
        saveToDb();
    }
    ...
    public boolean setLeaderId(final int c, boolean sameGuild) {
        ...
        guilds[0] = oldGuild;
        if (leaderName != null) {
            broadcast(MaplePacketCreator.serverNotice(5, leaderName + " 님이 새로운 길드 연합장이 되었습니다."));
        }
