...
public class MapleFamilyCharacter implements java.io.Serializable {
    ...
    private int elapsedLoginTime = 0;
    private long lastUpdate = 0;
    public MapleCharacter mc;
    ...
    public int getElapsedLoginTime() {
        if (!online) {
            return 0;
        }
        try {
            if (lastUpdate + 60000 < System.currentTimeMillis()) {
                ...
                int mins = (int) ((System.currentTimeMillis() - chr.getFirstLoginTime()) / 60000L);
                elapsedLoginTime = mins;
                lastUpdate = System.currentTimeMillis();
            }
            return elapsedLoginTime;
        } catch (Exception e) {
            return 0;
        }
    }
