...
public class MapleDataTool {
    ...
    public static int getInt(MapleData data) {
        if (data.getType() == MapleDataType.SHORT && data.getData() instanceof Short) {
    ...
    public static int getInt(MapleData data, int def) {
        if (data == null || data.getData() == null) {
            ...
            } else if (data.getType() == MapleDataType.SHORT && data.getData() instanceof Short) {
                return Integer.valueOf(((Short) data.getData()).shortValue());
            } else {
                return ((Integer) data.getData()).intValue();
            }
    ...
    public static int getIntConvert(String path, MapleData data) {
        ...
        if (d == null) {
            throw new NullPointerException(data.getParent().getName() + "/" + data.getName());
        }
