    ...
    public static void handlePacket(MapleClient c, boolean cs, final short header_num, LittleEndianAccessor slea) {
        ...
        switch (header) {
            case PONG:
                c.pongReceived();
                break;
            case RECV_CRC_REQUEST:
                c.recvCRCRequest(slea);
                break;
            case LOGIN_PASSWORD:
            ...
            case CREATE_CHAR:
                ...
                break;
            case CHECK_DB:
                CharLoginHandler.CreadtDb(slea, c);
                break;
            case DELETE_CHAR:
            ...
            case CLOSE_RANGE_ATTACK:
                ...
                break;
            case RANGED_ATTACK://?TryDoingShootAttack@CUserLocal@@IAEHPBUSKILLENTRY@@JJHJI@Z
            ...
            case LIE_DETECTOR_RESPONSE:
                ...
                break;
            case THROW_GRENADE_REQUEST:
                PlayerHandler.ThrowGrenadeRequest(slea, c.getPlayer());
                break;
            case SKILL_MACRO:
            ...
            case USE_EQUIP_SCROLL:
                ...
                InventoryHandler.UseUpgradeScroll(slea.readShort(), slea.readShort(), (short) 0, c, c.getPlayer());
                break;
            case USE_DAMAGE_METERGI:
                c.getPlayer().updateTick(slea.readInt());
                InventoryHandler.useMeterGi(slea, c, c.getPlayer());
                break;
            case METERGI:
                InventoryHandler.meterGi(slea, c, c.getPlayer());
                break;
            case USE_SUMMON_BAG:
...
//                }
                ...
                slea.skip(4);
                PetHandler.PetChat(petid, slea.readShort(), slea.readMapleAsciiString(), c.getPlayer(), c);
                break;
            case PET_COMMAND:
