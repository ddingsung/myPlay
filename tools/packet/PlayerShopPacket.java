...
public class PlayerShopPacket {
    ...
    public static final byte[] titleBoxMessage(final int message) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static final byte[] titleBoxAlready1(final int channel, final int room) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static final byte[] titleBoxAlready2(final int channel, final int room) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static final byte[] getHiredMerch(final MapleCharacter chr, final HiredMerchant merch, final boolean firstTime) {
        ...
        mplew.write(5); //CMiniRoomBaseDlg::OnEnterResultStatic
        mplew.write(5); //CEntrustedShopDlg::CEntrustedShopDlg
        mplew.write(4); //donno
        ...
        if (merch.isOwner(chr)) {
            mplew.writeShort(0);
            mplew.writeShort(merch.getTimeLeft());
    ...
    public static final byte[] merchItemStore2() {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static final byte[] MerchantVisitorView(List<String> visitor, final int time) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
